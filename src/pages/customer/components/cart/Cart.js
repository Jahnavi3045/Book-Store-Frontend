...
import { Backdrop, Box, CircularProgress, Paper, Grid, Typography, Button, Dialog, DialogTitle, DialogContent, DialogContentText, TextField, DialogActions } from '@mui/material';
...
function Cart() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(error);
      enqueueSnackbar('Error while placing the order', { variant: 'error', autoHideDuration: 5000 });
    }
    finally {
      setLoading(false)
    }
